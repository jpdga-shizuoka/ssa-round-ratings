...
最新のPDGAプレーヤーレーティングと統計情報は、PDGAのウェブページのプレーヤープロフィールで確認できます。[MEMBERSHIPメニューから [Player Search] を選択し](https://www.pdga.com/players)、PDGA Numberにあなたの会員番号を入力することで、あなたのプロフィールを検索できます。
