...
PDGAヨーロッパの発展プログラムは、ヨーロッパ大陸でのディスクゴルフの成長を促進するために、2022年に設立されました。このプログラムは、ヨーロッパの会員費や大会料金から得られた資金の一部を再投資する手段として開始され、ヨーロッパ内におけるマルコポーロプログラムに代わる取り組みです。
...
| 大会クラス | 日程 | 名称 | 場所 |
|----------------|------|------|------|
| シルバー | 5月3日～5日 | ベルギーオープン | Braine-l'Alleud, ベルギー |
